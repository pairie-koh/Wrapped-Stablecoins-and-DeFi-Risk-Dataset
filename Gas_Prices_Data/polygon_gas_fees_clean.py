...
df = pd.read_csv(r"C:\Users\hello\OneDrive\Desktop\Wrapped Stablecoins\Gas_Prices_Data\polygan_gas_fees.csv")
...
result.to_csv('polygon_gas_fees_cleaned.csv', index=False)
