...
df = pd.read_csv(r"C:\Users\hello\OneDrive\Desktop\Wrapped Stablecoins\Gas_Prices_Data\optimism_gas_price_etherscan.csv")
...
result.to_csv('ethereum_gas_fees_clean_data.csv', index=False)
